...
int menu() {
    ...
    do {
        ...
        case 1:
        {
            ...
            GotoXY(65, 25); TextColor(15);
            cout << "     I_N_T_R_O_D_U_C_E     ";
            GotoXY(65, 27); TextColor(15);
            cout << "       S_E_T_T_I_N_G     ";
            GotoXY(65, 29); TextColor(15);
...
void loadgame(bool &checkLoad, int &choose)
{
    system("cls");
